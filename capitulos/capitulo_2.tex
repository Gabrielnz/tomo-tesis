...
\FloatBarrier	
	...
	\subsection{Coordenadas de cromaticidad CIE xyz}
		...
		De acuerdo con la recomendaci\'{o}n de la CIE, la integraci\'{o}n en las f\'{o}rmulas \ref{eq:X}, \ref{eq:Y} y \ref{eq:Z} puede llevarse a cabo con una sumatoria num\'{e}rica, con intervalos de longitud de onda equivalentes a 10 nan\'{o}metros para el caso del MiniScan XE Plus. Tomando en cuenta esto, los valores triest\'{i}mulo CIE XYZ ahora son calculados con las ecuaciones \ref{eq:Xsum}, \ref{eq:Ysum} y \ref{eq:Zsum}.
