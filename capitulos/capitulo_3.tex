\chapter{ Marco Metodol\'{o}gico}
	...
	Esta metodolog\'{i}a tiene una doble finalidad: generar un beneficio al cliente de la investigaci\'{o}n y al mismo tiempo generar conocimiento relevante. Por lo tanto, es una forma de investigar de car\'{a}cter colaborativo que busca unir la teor\'{i}a y la pr\'{a}ctica entre investigadores y practicantes, mediante un proceso de naturaleza c\'{i}clica.

	La representaci\'{o}n m\'{a}s habitual de la Investigaci\'{o}n-Acci\'{o}n es la descrita por \citeA{Baskerville}, en forma de cinco fases que conforman un ciclo, las cuales se muestran y se describen en la figura 3.1.
...
En esta metodolog\'{i}a se pueden emplear varias t\'{e}cnicas y procesos. En este sentido, se incluyeron algunos artefactos de la metodolog\'{i}a RUP (\textit{Rational Unified Process}) descrita por \citeA{Kroll&Kruchten}, para as\'{i} generar suficiente documentaci\'{o}n relevante y asegurar el criterio de mantenibilidad. 
