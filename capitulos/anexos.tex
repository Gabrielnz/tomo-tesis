...
\subsection*{Librer\'{i}as de terceros}
...
El respaldo de los datos de la base de datos spectradb se debe realizar de forma semanal. En caso de que ocurra una falla de electricidad durante la gesti\'{o}n de mediciones, historias, usuarios, o respaldo/recuperaci\'{o}n de la misma base de datos, verificar si dicha gesti\'{o}n tuvo efecto, en caso contrario, volverla a realizar.
...
Haga click en el bot\'{o}n <<...>>, seleccione la ubicaci\'{o}n y el nombre del archivo de respaldo (v\'{e}ase la figura \ref{fig:respaldar2}).
\vfill
\begin{figure}[H]
  \centering
...
En la aplicaci\'{o}n pgAdmin, haga click con el bot\'{o}n derecho al esquema <<spectradb>> y seleccione la opci\'{o}n <<Restore...>> ( v\'{e}ase la figura \ref{fig:restaurar1}).

\begin{figure}[H]
  \centering
  \includegraphics[width=.6\linewidth]{./img/restaurar1.jpg}
\caption[]{Opci\'{o}n de restauraci\'{o}n\label{fig:restaurar1}}
\end{figure}

Haga click en el bot\'{o}n <<...>>, ubique y seleccione el nombre del archivo de respaldo (v\'{e}ase la figura \ref{fig:restaurar2}).

\begin{figure}[H]
  \centering
  \includegraphics[width=.6\linewidth]{./img/restaurar2.jpg}
\caption[]{Archivo de respaldo\label{fig:restaurar2}}
\end{figure}

En la pesta\~{n}a <<Restore Options \#1>>, seleccione \'{u}nicamente la opci\'{o}n <<Data>>, y por \'{u}ltimo haga click en el bot\'{o}n <<Restore>> (v\'{e}ase la figura \ref{fig:restaurar3}).

\begin{figure}[H]
  \centering
  \includegraphics[width=.7\linewidth]{./img/restaurar3.jpg}
\caption[]{Restaurar datos\label{fig:restaurar3}}
\end{figure}