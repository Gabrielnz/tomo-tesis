...
Este cap\'{i}tulo presenta los trabajos relacionados, la observaci\'{o}n directa y las bases te\'{o}ricas que conforman los antecedentes de la investigaci\'{o}n que sustentan el desarrollo del presente trabajo de investigaci\'{o}n.
	...
	Como la absorbancia aparente es toda la luz que no est\'{a} siendo reflejada de vuelta al MiniScan XE Plus luego de que este la emite sobre el tejido en estudio, la misma se puede calcular de la siguiente manera: $A(\lambda) = 100 - R(\lambda)$, y se puede representar en forma de curva, de la misma manera que la reflectancia difusa.
