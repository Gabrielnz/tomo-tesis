...
\section{Pila del producto \textit{(product backlog)}}
	...
	\begin{table}[h]
		...
		\begin{tabulary}{\anchotabla}{|c|J|c|}
			...
			\textbf{RF02} & Recuperar los 31 puntos espectrales de una medici\'{o}n con el MiniScan XE Plus y mostrarlos en su forma num\'{e}rica. & Esencial\\ \hline
			...
			\textbf{RF11} & Exportar los datos de una muestra a un archivo port\'{a}til. & Esencial\\ \hline
		\end{tabulary}
	\end{table}
