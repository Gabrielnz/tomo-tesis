...
\section{Base de datos}
	...
	\subsection{Descripci\'{o}n de las tablas de la base de datos}
		...
		\begin{itemize}
				...
				\item \textbf{datos\_absorci\'{o}n:} contiene los 31 puntos espectrales resultantes del c\'{a}lculo del coeficiente de absorci\'{o}n asociado con los datos espectrales.
