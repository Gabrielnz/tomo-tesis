...
\subsection{Casos de uso}
 ...
 \begin{itemize}
 	...
 	\item \textbf{Manejo del MiniScan XE Plus:}
 	
 		\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{img/cu-manejar-miniscan.png}
			\caption[Caso de uso: manejo del MiniScan XE Plus]{\textit{ Caso de uso: Manejo del MiniScan XE Plus} (Fuente: Autor).}
	\end{figure}
	
	 	\item \textbf{Gesti\'{o}n de medici\'{o}n:}
 	
 		\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{img/cu-gestion-medicion.png}
			\caption[Caso de uso: gesti\'{o}n de medici\'{o}n]{\textit{ Caso de uso: gesti\'{o}n de medici\'{o}n} (Fuente: Autor).}
	\end{figure}

\newpage
	 	\item \textbf{Gesti\'{o}n de sesi\'{o}n:}
 	
 		\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{img/cu-gestion-sesion.png}
			\caption[Caso de uso: gesti\'{o}n de sesi\'{o}n]{\textit{ Caso de uso: Gesti\'{o}n de sesi\'{o}n} (Fuente: Autor).}
	\end{figure}
	
		 	\item \textbf{Gesti\'{o}n de historia:}
 	
 		\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{img/cu-gestion-historia.png}
			\caption[Caso de uso: gesti\'{o}n de historia]{\textit{ Caso de uso: Gesti\'{o}n de historia} (Fuente: Autor).}
	\end{figure}

\newpage
		\item \textbf{Gesti\'{o}n de muestra:}
 	
 		\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{img/cu-gestion-muestra.png}
			\caption[Caso de uso: gesti\'{o}n de muestra]{\textit{ Caso de uso: Gesti\'{o}n de muestra} (Fuente: Autor).}
	\end{figure}
	
			\item \textbf{gesti\'{o}n de usuario:}
 	
 		\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{img/cu-gestion-usuario.png}
			\caption[Caso de uso: gesti\'{o}n de usuario]{\textit{ Caso de uso: Gesti\'{o}n de usuario} (Fuente: Autor).}
	\end{figure}
...
\section{Tecnolog\'{i}as y recursos utilizados}
	...
	\subsection{Tecnolog\'{i}as}
		...
		\begin{itemize}
			...
			\item \textbf{Gitlab:} es un servicio de control de versiones, que ofrece alojamiento gratuito, tanto p\'{u}blico como privado, de respositorios para proyectos. Se utiliz\'{o} la versi\'{o}n en l\'{i}nea de este servicio para utilizar control de versiones durante el desarrollo del proyecto.
